...
postgres=# begin;
BEGIN
postgres=*# declare cursor_products cursor for select * from products;
DECLARE CURSOR
postgres=*# move forward 20 from cursor_products;
MOVE 20
postgres=*# fetch backward 10 from cursor_products;
 id |    name    | count | price
----+------------+-------+-------
 19 | product_19 |    19 |    95
 18 | product_18 |    18 |    90
...
postgres=*# move backward 1 from cursor_products;
MOVE 1
postgres=*# fetch backward 8 from cursor_products;
 id |   name    | count | price
----+-----------+-------+-------
  7 | product_7 |     7 |    35
  6 | product_6 |     6 |    30
