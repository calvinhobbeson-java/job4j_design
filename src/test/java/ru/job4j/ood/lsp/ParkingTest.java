...
class ParkingTest {
    ...
    public void whenStart()  {
        CarSlots carslots = new CarSlots(new ArrayList<>(2), 2);
        TruckSlots truckSlots = new TruckSlots(new ArrayList<>(2), 2);
    ...
    @Test
    public void whenTruckIntoCarSpots()  {
        CarSlots carslots = new CarSlots(new ArrayList<>(2), 2);
        TruckSlots truckSlots = new TruckSlots(new ArrayList<>(2), 2);
        Auto kamaz = new Kamaz(2);
        Auto kamaz2 = new Kamaz(2);
        Parking parking = new Parking(new ArrayList<>(List.of(kamaz, kamaz2)), new ArrayList<>(List.of(carslots, truckSlots)));
        parking.park();
        List<Auto> expected = List.of(kamaz2);
        assertThat(carslots.getSlots().equals(expected));
    }
}
